...
?>
  ...
  <header>
    ...
    <div class="header-banner"style="background-image: url('../img/wikipedia.jpg');">
  ...
  <div class="row">
    <article>
       ...
       <center><button type="button" class="btn btn-primary"style=" background-image: linear-gradient(to right, #a517ba, #5f1782);"><a href ="top-web-design-language.php"style="color: white;">prev</a></button>
                  ...
                  <center><button type="button" class="btn btn-primary"style=" background-image: linear-gradient(to right, #a517ba, #5f1782);"><a href ="top-computer-companies.php"style="color: white;">prev</a></button>
                  <button type="button" class="btn btn-primary"style=" background-image: linear-gradient(to right, #a517ba, #5f1782);"><a href= "best-graphic-design-software.php"style="color: white;">next</a></button></center>
